...
<div class="container">
    ...
    <nav>
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="<?= app()->route->getUrl('/hello') ?>" class="nav-link px-2 link-secondary">Сотрудники по подразделениям</a></li>
            <li><a href="<?= app()->route->getUrl('/hello') ?>" class="nav-link px-2 link-dark">Сотрудники по подразделениям</a></li>
            <li><a href="<?= app()->route->getUrl('/hello') ?>" class="nav-link px-2 link-dark">Возраст сотрудников</a></li>
        <?php
        if (!app()->auth::check()):
            ?>
...
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center">
        ...
        <span class="text-muted">© Февраль 2022 УП ПнСС 09</span>
    </div>
